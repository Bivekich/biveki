...
export const workExperience = [
  {
    id: 1,
    title: "Изучение Backend-разработки",
    desc: "Получил базовые знания в области бэкенд-разработки, сосредоточившись на серверных технологиях.",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    id: 2,
    title: "Пет-проекты — Разработка ботов",
    desc: "Создавал различные пет-проекты с акцентом на разработку ботов и автоматизацию процессов.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
  {
    id: 3,
    title: "Разработчик в Яндекс",
    desc: "Работал более полугода в Яндексе, участвовал в крупных проектах, набираясь ценного опыта.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
    id: 4,
    title: "Руководитель собственного бизнеса",
    desc: "Успешно управляю командой из более чем 10 сотрудников, реализуя разнообразные проекты для клиентов.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
