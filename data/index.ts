...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Работал более года в Яндексе, участвовал в крупных проектах, набираясь ценного опыта.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
    ...
    desc: "Успешно управляю командой из более чем 20 сотрудников, реализуя разнообразные проекты для клиентов.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
